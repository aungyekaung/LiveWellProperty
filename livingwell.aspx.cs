...
public partial class _livingwell : System.Web.UI.Page
{
    ...
    {
        var results = GoogleMapAPIGetLatLong.GoogleMapAPIGeoCoding(txtSearch.Text.Trim());
    ...
    {
        Response.Redirect("ShowLocation.aspx?Address=" +
